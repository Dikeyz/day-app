      ...
      <!-- Pengelompokkan -->
            ...
            <?php
              ...
              <?php
               ...
               $no = 1;
               $query        = "SELECT * FROM transaksi 
                              INNER JOIN akun on transaksi.no_akun = akun.no_reff AND akun.nama_akun = '153-PERLENGKAPAN' WHERE transaksi.umkm ORDER BY tgl_transaksi ASC";                
               $jurnal_umum  = mysqli_query($koneksi, $query) or die(mysqli_error($koneksi));
            ...
            ?> 
              ...
              <?php
               ...
               $no = 1;
               $query        = "SELECT * FROM transaksi 
                              INNER JOIN akun on transaksi.no_akun = akun.no_reff AND akun.nama_akun = '610-BEBAN IKLAN ' WHERE transaksi.umkm ORDER BY tgl_transaksi";                
               $jurnal_umum  = mysqli_query($koneksi, $query) or die(mysqli_error($koneksi));
