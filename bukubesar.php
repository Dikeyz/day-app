          ...
          <tbody>
            <?php
               ...
               $query       = "SELECT * FROM transaksi 
                              INNER JOIN akun on transaksi.no_akun = akun.no_reff AND akun.nama_akun = '105-KAS DI BANK' WHERE transaksi.user_id = {$_SESSION['user_id']} ORDER BY tgl_transaksi ASC";
        ...
        <table class="table table-hover">
          ...
          <tbody>
            <?php
               ...
               $no = 1;
               $query       = "SELECT * FROM transaksi 
                              INNER JOIN akun on transaksi.no_akun = akun.no_reff AND akun.nama_akun = '101-KAS DI TANGAN' WHERE transaksi.user_id = {$_SESSION['user_id']} ORDER BY tgl_transaksi ASC";
               $jurnal_umum = mysqli_query($koneksi, $query) or die(mysqli_error($koneksi));
